...
class ClientsRepository extends ServiceEntityRepository
{
    ...
    {
       return $this->getEntityManager()->createQuery('SELECT clients.id, clients.dpi, clients.name, clients.lastname, clients.email, clients.phone
       From App:Clients clients');
    }
